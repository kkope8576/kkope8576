...
namespace Example._02020000000001_EvenI.Programming.E01.Example.Classes.Runtime.Example_03
{
	...
	internal class CE01Example_03
	{
		...
		public static void Start(string[] args)
		{
             ...
             * 메서드를 지원한다. (즉, Parse 계열 메서드를 활용하면 문자열 데이터를 간단하게 
             * 원하는 자료형의 데이터로 변환하는 것이 가능하다.)
             * 
			...
			/*
             * 논리 연산자의 피연산자는 논리 (bool) 자료형 데이터만 사용가능하기 때문에 정수와 같은 
             * 데이터를 비교 연산 등을 통해서 논리 자료형으로 변환해줄 필요가 있다.
             * 
             * 일반적으로 컴퓨터는 0 을 제외한 모든 데이터를 참으로 인식하지만 C# 은 참 또는 거짓에 
