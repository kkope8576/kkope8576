 ...
 * 
 * 점프문이란?
 * - 프로그램의 흐름을 특정 위치로 이동시키는 기능을 의미한다. (즉, 점프문을 활용하면 프로그램의 
 * 흐름을 제한적으로 제어하는 것이 가능하다.)
 * 
 * C# 점프문 종류
 * - break
 * - continue
 ...
 * 
 * break 문이란?
 * - 프로그램의 흐름을 제어문 밖으로 이동시키는 기능을 의미한다. (즉, break 문은 반복문과 
 * switch ~ case 조건문 내부에서만 사용하는 것이 가능하다.)
 * 
 * continue 문이란?
	...
	internal class CE01Example_05
	{
		...
		public static void Start(string[] args)
		{
			...
			for(int i = 0; i < nNum; ++i)
			{
				...
				{
					/*
                     * for 반복문 내부에서 continue 키워드는 while 반복문에 비해
                     * 좀 더 안전하게 작성하는 것이 가능하다. (즉, for 반복문에서
                     * 실행 명령문의 흐름을 생략한다 하더라도 조건을 깨기 위한
                     * 반복절이 실행되기 때문에 while 문에 비해 의도치않게 무한
                     * 루프를 만들어내는 실수를 줄이는 것이 가능하다.)
                     */
					continue;
				}
