...
using Example._02020000000001_EvenI.Structure.E01.Example.Classes.Runtime.Example_03;
...
namespace Example._02020000000001_EvenI.Structure.E01.Example.Classes.Runtime.Example_07
{
	 ...
	 * 그래프 - 인접 행렬
	 */
	internal class CE01Graph_AdjacencyMatrix_07<TKey, TVal> where TKey : IComparable where TVal : IComparable
	{
		/**
		 * 순서
		 */
		...
		public CE01List_Array_02<CVertex> ListVertices { get; private set; } = null;
		public List<CE01List_Array_02<bool>> ContainerListEdges { get; private set; } = null;

		public int NumVertices => this.ListVertices.NumValues;

		/** 생성자 */
		public CE01Graph_AdjacencyMatrix_07(int a_nSize = 5)
		{
			this.ListVertices = new CE01List_Array_02<CVertex>();
			this.ContainerListEdges = new List<CE01List_Array_02<bool>>();
		}
		...
		public void AddVertex(TKey a_tKey, TVal a_tVal)
		{
			...
			this.ContainerListEdges.Add(new CE01List_Array_02<bool>());
			...
			for(int i = 0; i < this.ContainerListEdges.Count; ++i)
			{
				...
				{
					this.ContainerListEdges[i].AddVal(false);
				}
			}
		}

		/** 간선을 추가한다 */
		public void AddEdge(TKey a_tFrom, TKey a_tTo)
		{
			...
			this.ContainerListEdges[nResult_From][nResult_To] = true;
		}
		...
		public void RemoveEdge(TKey a_tFrom, TKey a_tTo)
		{
			...
			this.ContainerListEdges[nResult_From][nResult_To] = false;
		}
		...
		/** 정점을 탐색한다 */
		private int FindVertexAt(TKey a_tKey)
		{
			...
			Action<TKey, TVal> a_oCallback, List<TKey> a_oOutListKeys_Visit)
		{
			...
			{
				// 값 순회가 불가능 할 경우
				if(!this.ContainerListEdges[nResult][i])
				{
					continue;
				}
				...
				this.EnumerateByOrder_DepthFirst(this.ListVertices[i].m_tKey,
		...
		private void EnumerateByOrder_BreadthFirst(TKey a_tKey,
			Action<TKey, TVal> a_oCallback, List<TKey> a_oOutListKeys_Visit)
		{
			var oQueueKeys = new CE01Queue_03<TKey>();
