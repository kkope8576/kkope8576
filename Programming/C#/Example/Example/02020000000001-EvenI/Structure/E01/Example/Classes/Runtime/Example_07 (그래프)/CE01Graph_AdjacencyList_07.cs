...
namespace Example._02020000000001_EvenI.Structure.E01.Example.Classes.Runtime.Example_07
{
	 ...
	 * 그래프 - 인접 리스트
	 */
	internal class CE01Graph_AdjacencyList_07<TKey, TVal> where TKey : IComparable where TVal : IComparable
	{
		/**
		 * 순서
		 */
		...
		public class CVertex : IComparable
		{
			...
			public CE01List_Array_02<CEdge> m_oListEdges = null;
		...
		/** 생성자 */
		public CE01Graph_AdjacencyList_07(int a_nSize = 5)
		{
			this.ListVertices = new CE01List_Array_02<CVertex>(a_nSize);
		}
		...
		public void AddEdge(TKey a_tFrom, TKey a_tTo)
		{
			...
			// 간선 추가가 불가능 할 경우
			if(oVertex == null || oEdge != null)
			{
				return;
			}

			oEdge = this.CreateEdge(a_tFrom, a_tTo);
		...
		private CVertex CreateVertex(TKey a_tKey, TVal a_tVal)
		{
			return new CVertex()
			{
				...
				m_oListEdges = new CE01List_Array_02<CEdge>()
			};
		}

		/** 간선을 생성한다 */
		private CEdge CreateEdge(TKey a_tFrom, TKey a_tTo)
		{
			return new CEdge()
			{
				m_tFrom = a_tFrom,
