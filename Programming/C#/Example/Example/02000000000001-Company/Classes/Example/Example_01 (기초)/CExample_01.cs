/*
 * using 키워드란?
 * - 특정 네임 스페이스 하위 존재하는 기능을 가져오는 역할을 수행한다. (즉, 해당 키워드를 사용하면
...
/*
 * 네임 스페이스란?
 * - 클래스와 같은 여러가지 기능을 그룹화 시킬 수 있는 기능을 의미한다. (즉, 네임 스페이스를 
 * 활용하면 여러 기능들을 특징에 따라 분류해서 관리하는 것이 가능하다.)
 * 
 * 프로그램이란?
 ...
 * 
 * 프로그래밍 언어란?
 * - 컴퓨터 작업을 지시 할 프로그램을 제작하기위한 언어를 의미한다. (즉, 프로그래밍 언어를 활용하면
 * 컴퓨터와 대화를 하는 것이 가능하다.)
 * 
 * 단, 컴퓨터는 0 과 1 로 이루어진 기계어 코드만을 인지 할 수 있기 때문에 해당 언어를 제외한 다른
 * 언어는 기계어 코드로 변환 될 필요가 있다는 것을 알 수 있다. (즉, 기계어를 제외한 다른 언어는
 * 컴파일러 또는 인터프리터의 도움을 받을 필요가 있다는 것을 알 수 있다.)
 * 
 * 컴파일러란?
 * - 프로그래밍 언어로 작성 된 명령문을 기계어로 변환하는 역할을 수행하는 프로그램을 의미한다. (즉, 
 * 컴파일러가 존재하기 때문에 기계어를 몰라도 컴퓨터에게 특정 명령을 내리는 것이 가능하다.)
 * 
 * 인터프리터란?
...
namespace Example._02000000000001_Company.Classes.Example.Example_01
{
	/*
     * 클래스란?
     * - 여러 메서드를 포함하고 있는 기능을 의미한다. (즉, 클래스 내부에는 여러가지 기능에 해당하는
     * 메서드가 존재한다는 것을 알 수 있다.)
     * 
